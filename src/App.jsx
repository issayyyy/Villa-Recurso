 ...
 * CTAs   : All booking buttons → https://m.me/VillaRecurso
...
const T = {
  ...
  /* Messenger CTA target */
  messengerURL: "https://m.me/VillaRecurso",
};

/* ────────────────────────── Reusable CTA ───────────────────────── */
function CTABtn({ children, style = {}, iconLeft }) {
  ...
  return (
    <a
      ...
      style={{
        ...
        boxShadow: hov
          ? "0 10px 32px rgba(255,176,84,0.45)"
          : "0 3px 16px rgba(255,176,84,0.25)",
...
function Nav() {
  ...
  return (
    <header style={{
      ...
      /* Only show border-bottom after scroll — avoids parallel-line on hero */
      ...
      <div style={{
        ...
        {/* Logo — natural render, NO filter inversion */}
      ...
      <div style={{
        ...
        <div style={{ padding: "14px 40px 24px" }}>
          ...
          <div style={{ marginTop: 20 }}>
            <CTABtn style={{ width: "100%", justifyContent: "center" }}>
              Book Now
            </CTABtn>
          </div>
        </div>
...
function Hero() {
  ...
  return (
    <section id="hero" style={{
      /* Stretch edge-to-edge — no margin anywhere */
      position: "relative",
      width: "100%",
      minHeight: "100vh",
      ...
      {/* Multi-layer darkening overlays — no border/margin gap */}
      <div style={{
        position: "absolute", inset: 0,
        background: "linear-gradient(to bottom, rgba(8,6,4,0.52) 0%, rgba(8,6,4,0.28) 42%, rgba(8,6,4,0.62) 100%)",
      }} />
      <div style={{
        position: "absolute", inset: 0,
        background: "radial-gradient(ellipse at center, rgba(0,0,0,0) 20%, rgba(0,0,0,0.45) 100%)",
      }} />
      ...
      <div style={{
        ...
        {/* Logo — shown as-is, full color on dark photo */}
        ...
        <div style={{ ...anim(1.05), display: "flex", gap: 14, flexWrap: "wrap", justifyContent: "center" }}>
          ...
          <a
            ...
            onMouseEnter={e => {
              e.currentTarget.style.borderColor = "rgba(255,176,84,0.55)";
      ...
      <div style={{
        ...
        <p style={{
          fontFamily: T.sans, fontSize: 9, letterSpacing: "0.26em",
      ...
      {/* Hard fade into page background — eliminates any gap/line */}
      <div style={{
...
function StatsStrip() {
  return (
    <div style={{
      ...
      /* No extra border-top — the hero fade blends straight into this */
      borderBottom: `1px solid ${T.stone}`,
      padding: "26px 40px",
...
const rooms = [
  ...
  },
  {
    id: "octatel",
    name: "Octatel Room",
    sub: "Mountain Cozy Bure",
    badge: null,
    price: "2,000",
    image: "public/octatel.jpg",
  ...
  },
  {
    id: "dojo",
    name: "Japanese Dojo",
    sub: "Zen Highland Retreat",
    badge: "✦ Premium",
    price: "6,000",
    image: "public/japanese-dojo.jpg",
  ...
  },
  {
    id: "villa",
    name: "Family Villa",
    sub: "The Crown Residence",
    badge: "◈ Luxury",
    price: "12,000",
    image: "public/resort-5.jpg",
    ...
    >
      <div
        ...
        style={{
          ...
          /* ── Smooth lift effect ── */
          boxShadow: hov
            ? "0 28px 64px rgba(0,0,0,0.13), 0 6px 24px rgba(255,176,84,0.12)"
      ...
      >
        ...
        {/* Image column */}
        <div
          className={`room-img-col${room.flip ? " flip-img" : ""}`}
        ...
        >
          ...
          <div style={{
            ...
            background: "rgba(8,6,4,0.72)", backdropFilter: "blur(12px)",
            borderRadius: 50, padding: "7px 18px",
            border: "1px solid rgba(255,255,255,0.12)",
          }}>
            <span style={{ fontFamily: T.serif, fontSize: 19, fontWeight: 500, color: T.yellow }}>
              ₱{room.price}
              <span style={{ fontFamily: T.sans, fontSize: 11, fontWeight: 300, color: "rgba(255,255,255,0.45)", marginLeft: 4 }}>/night</span>
            </span>
          </div>
          ...
          {room.badge && (
            <div style={{
              ...
              background: "rgba(8,6,4,0.6)", backdropFilter: "blur(10px)",
        ...
        {/* Text column */}
        <div
          className={`room-text-col${room.flip ? " flip-text" : ""}`}
    ...
    >
      ...
      <div style={{
        ...
        background: hov
          ...
          : "linear-gradient(to top, rgba(0,0,0,0.32) 0%, transparent 48%)",
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "0 28px" }}>
        <div style={{ marginBottom: 52 }}>
          <SectionHeading
            ...
            title="Find Us in the Highlands"
  ...
  return (
    <section id="contact" style={{
      ...
      <div style={{
        ...
        background: `radial-gradient(circle, rgba(255,176,84,0.09), transparent 65%)`,
        pointerEvents: "none",
      }} />
      <div style={{
        position: "absolute", top: -80, left: -80,
        width: 360, height: 360, borderRadius: "50%",
        background: `radial-gradient(circle, rgba(255,215,55,0.07), transparent 65%)`,
        pointerEvents: "none",
      }} />
      ...
      >
        ...
        <div style={{
          width: 1, height: 52,
          background: `linear-gradient(to bottom, transparent, rgba(255,176,84,0.5))`,
          margin: "0 auto 30px",
        }} />

        <p style={{ fontFamily: T.sans, fontSize: 10, fontWeight: 500, letterSpacing: "0.3em", textTransform: "uppercase", color: T.orange, marginBottom: 14 }}>
          Begin Your Journey
        </p>
        ...
        <h2 style={{
          ...
          color: T.text, lineHeight: 1.2, margin: "0 0 18px",
        }}>
          Plan Your Escape
        </h2>

        <p style={{ fontFamily: T.sans, fontSize: 14, fontWeight: 300, color: T.mid, lineHeight: 1.9, marginBottom: 44 }}>
          Message us on Facebook and we'll help craft the perfect highland
          getaway. Our team responds within 24 hours.
        </p>

        {/* Main CTA */}
        <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap", marginBottom: 52 }}>
          <CTABtn iconLeft={<Mail size={14} />} style={{ padding: "14px 34px" }}>
            Message Us Now
          </CTABtn>
          <a
            href="tel:+639510265165"
            style={{
              display: "inline-flex", alignItems: "center", gap: 8,
              fontFamily: T.sans, fontSize: 11, fontWeight: 500,
              letterSpacing: "0.14em", textTransform: "uppercase",
  ...
  return (
    <footer style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        {/* Natural logo — on dark footer use opacity + slight brightness boost */}
        <img
          src="public/logo.png"
          alt="Villa Recurso"
          style={{ height: 26, opacity: 0.55 }}
        />
        <span style={{ fontFamily: T.sans, fontSize: 11, color: "rgba(255,255,255,0.35)", fontWeight: 400 }}>
          Villa Recurso
        </span>
      </div>
      ...
      <a
        href="https://www.facebook.com/VillaRecurso"
...
export default function App() {
  return (
    <>
      ...
      <style>{`
        /* Hard reset — removes any browser margin that causes parallel lines */
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 640px) {
          .room-text-col { padding: 28px 24px !important; }
        }
      `}</style>
    </>
  );
